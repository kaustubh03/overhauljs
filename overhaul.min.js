...
function checkTimestampDiff(recordedTimeStamp) {
  const now = Date.now();
...
*/
function persistor(initialState) {
...
export { checkTimestampDiff, generateInitialState, mapActions, persistor, stateSettler };
